...
<html lang="en">
	<head>
        ...
        <link href="<?php echo $this->themePath('css/custom.css') ?>" rel="stylesheet">
    ...
    <div class="header_logo text-center"><span style="display:inline-block;"><img src="<?php echo $this->themePath('img/logo.png') ?>" class="img-responsive" alt="Logo"></span></div>
