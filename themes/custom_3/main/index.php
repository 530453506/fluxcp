...
<?php if(Flux::config('CMSNewsOnHomepage')): ?>
    ...
    <p>
        Oh hai der! This is a test installation of FluxCP for Akkarin to do tests on. Sometimes Akky dabbles in some quick theming when bored. This text can be changed in /themes/clouds/main/index.php at the top, and should be changed to something more meaningful instead of just some blarg text to fill a gap. 'Cus who really like looking at Lorem Ipsum anyway!?
    </p>
